  ...
  return (
    <div id="TrainerHelpContainer" style={{paddingBottom: "20px"}}>
      ...
      <div id="nav-trainer-overview" className="topicSection">
        ...
        to transcribe morse code, or to practice and maintain proficiency. The tool works by playing audible morse code 
        to the user whilst they attempt to type out the respective characters. Following every training session, the user's 
        performance is marked and scored and a detailed breakdown is given. New users should begin with a small character 
        set and slower speeds and increase both of these factors incrementally every time they obtain consistantly good scores.</p>
      </div>
      <div id="nav-trainer-setting-the-morse-speed" className="topicSection">
        ...
        time to assimilated a transmitted character whilst still being able to learn the "shape" of the morse characters at the full 
      ...
      <div id="nav-trainer-tailoring-the-sessions-in-character-selector" className="topicSection">
        ...
        changing the time duration, altering the placement of spaces and selecting the number of currently selected characters.</p>
        <br />
        ...
        <br />
        <h4>Altering the Placement of Spaces</h4>
        ...
        <img src={ImgSpaces} alt="Speed" width='318' height='193' /><br />
        <br />
      </div>
      <div id="nav-trainer-" className="topicSection">
        <h3></h3>
        <p></p>
      </div>
    </div>
