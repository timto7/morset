  ...
  return (
    <div id="GeneralHelpContainer" style={{paddingBottom: "20px"}}>
      ...
      <div id="section-general-navigation" className="topicSection">
        ...
        persistently located at the very top of the application. Key navigation buttons can be found
        in the leftmost portion of the navigation bar.</p>
        <img src={ImgNavItems} alt="Navigation" width='247' height='59' />
      </div>
      <div id="section-general-changing-the-volume" className="topicSection">
      ...
      <div id="section-general-changing-the-tone-frequency" className="topicSection">
      ...
      <div id="section-general-changing-the-stereo-position" className="topicSection">
      ...
      <div id="section-general-setting-the-oscillator-waveform" className="topicSection">
      ...
      <div id="section-general-toggling-the-amplitude-envelope" className="topicSection">
        ...
        and ultimately prevents an audible "clicking" artefact. This feature can be toggled using the <b>amplitude envelope toggle 
